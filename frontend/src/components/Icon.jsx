...
const P = {
  ...
  /* ---- seasonal / themes ---- */
  pumpkin: <><path d="M12 2.8c.8 1.4 1.2 2.6 1 3.8M5.8 8.6C4 10.4 3 13 3 15.6c0 3.8 3.5 5.6 9 5.6s9-1.8 9-5.6c0-2.6-1-5.2-2.8-7C16.4 7 14.3 6.6 12 6.6S7.6 7 5.8 8.6Z" /><path d="M8.8 6.8C7.5 8.8 6.8 11.8 6.8 15.2c0 3.2.7 5 2 5.8M15.2 6.8c1.3 2 2 5 2 8.4 0 3.2-.7 5-2 5.8M9 12.2l1.2-1.8 1.2 1.8M15 12.2l-1.2-1.8-1.2 1.8M8.5 16.8l1.7-1 1.8 1 1.8-1 1.7 1" /></>,
  ghost: <><path d="M12 3.6c-4.4 0-8 3.6-8 8v8.6c0 .5.6.8 1 .5l1.6-1.1 1.8 1.2c.4.3 1 .3 1.4 0l1.6-1.1 1.6 1.1c.4.3 1 .3 1.4 0l1.8-1.2 1.6 1.1c.4.3 1 0 1-.5v-8.6c0-4.4-3.6-8-8-8Z" /><circle cx="9.5" cy="11.5" r="1.1" fill="currentColor" stroke="none" /><circle cx="14.5" cy="11.5" r="1.1" fill="currentColor" stroke="none" /><path d="M11 14.8c.6.4 1.4.4 2 0" /></>,
  bat: <path d="M12 9.5c-1.5-3.5-5.5-4-8.5-3 1 2.5 1.5 5.5 0 8.5 2.5-.5 5-.5 6.5 1.5 1.5-2 4-2 6.5-1.5-1.5-3-1-6 0-8.5-3-1-7-.5-8.5 3M10.8 8l1.2-2 1.2 2" />,
  spiderweb: <><path d="M4 4h16M4 4v16M4 4l14 14M4 10c2.8 0 5-2.2 6-6M4 16c5.5 0 10-4.5 12-12M4 22c8.3 0 15-6.7 18-18" /></>,
  snowflake: <><path d="M12 3v18M4.2 7.5l15.6 9M4.2 16.5l15.6-9M12 5.5l2 2M12 5.5l-2 2M12 18.5l2-2M12 18.5l-2-2M6.5 8.8l2.8-.2M6.5 8.8l-.8 2.8M17.5 15.2l-2.8.2M17.5 15.2l.8-2.8M6.5 15.2l.8-2.8M6.5 15.2l2.8.2M17.5 8.8l-.8 2.8M17.5 8.8l-2.8-.2" /></>,
  tree: <><path d="m12 2.8.8 1.6 1.8.2-1.3 1.3.3 1.8-1.6-.9-1.6.9.3-1.8-1.3-1.3 1.8-.2Z" /><path d="m12 7.8-4 4.2h2.4L7 16h3.2L8 20.2h8L13.8 16H17l-3.4-4h2.4Z" /><path d="M11 20.2v2.4h2v-2.4" /></>,
  candyCane: <><path d="M15 20.4V9.6a4.8 4.8 0 0 0-9.6 0v2.4" /><path d="m7.2 7.6 2.4-2.4M12.6 5.2l2.4 2.4M15 11l-3 3M15 15l-3 3M15 19l-1.5 1.5" /></>,
  gift: <><rect x="4.4" y="9.4" width="15.2" height="11.2" rx="2" /><path d="M3.4 9.4h17.2v3.2H3.4ZM12 9.4v11.2M7.8 6.2c-1.4 0-2.4.8-2.4 2 0 1.2 1.4 1.2 3.8 1.2h2.8V6.6c0-1.8-1.2-2.4-2.2-2.4-.8 0-1.6.8-2 2ZM16.2 6.2c1.4 0 2.4.8 2.4 2 0 1.2-1.4 1.2-3.8 1.2h-2.8V6.6c0-1.8 1.2-2.4 2.2-2.4.8 0 1.6.8 2 2Z" /></>,
}
